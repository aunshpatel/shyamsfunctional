				...
				<div class="row">
					...
					<?php
							if(isset($_SESSION["mem_em"]))  {
								echo "<b><font color='black'>Welcome ".$_SESSION['mem_em']."</font></b>";
							} 
							else if(isset($_SESSION["email"])) 
							{
								echo "<b><font color='black'>Welcome ".$_SESSION['email']."</font></b>";
							}
						?>
			...
			<div class="row align-items-center justify-content-between d-flex">
				...
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						...
						<li><a href="http://localhost/fin/Zumba/shop.php">Supplement</a></li>
						<?php
						if(isset($_SESSION["mem_em"])){
						...
						<li><a class="active" href="http://localhost/fin/Zumba/contact.php">Contact Us</a></li>
					</ul>
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="link-nav"><a href="http://localhost/fin/Zumba/home.php">Home </a>
						<span class="lnr lnr-arrow-right"></span> <a href="http://localhost/fin/Zumba/elements.php">
							Elements</a></p>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget">
						<h4>About Us</h4>
						<p>
							Shyam's Functional Fitness Studio is located in Vadodara and provides all the types of Zumba exersises do visit once!
						</p>
					</div>
				</div>
			...
			<div class="footer-bottom row align-items-center">
				...
				<div class="col-lg-6 col-sm-12 footer-social">
					<a href="https://www.facebook.com/Shyams-Functional-Fitness-Studio-858024620952164/?ref=br_rs"><i class="fa fa-facebook"></i></a>
