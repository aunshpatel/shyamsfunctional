...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Member Password Reset Page</title>
...
<body onload="myFunction()" style="margin:0;">
	...
	<?php 
		if(isset($_POST["reset"]))
		{
			...
			$sql="UPDATE member SET Password='$pass' where Email='$em'";  

			$result=mysqli_query($sql,$conn);
			if(!$result)  {  
				echo "<script type='text/javascript'>";
				echo "alert('Password not changed. Please try again!');"; 
				echo "window.location.href='memberforgot.php';";
				echo "</script>";  
			}  else {      
				echo "<script type='text/javascript'>";
	...
	<section class="banner-area relative about-banner" id="home">
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				...
				<div class="header">
					<h2>Did Member forget password? Reset it below</h2>
				</div>
