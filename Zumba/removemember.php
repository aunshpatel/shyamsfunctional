...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Remove Member Page</title>
		...
		{  
			if(isset($_REQUEST["remove"])){ 
				...
				if($result){ 
					...
					echo "<script type='text/javascript'>";
					echo "alert('Member not removed, please enter a valid email address');"; 
					echo "window.location.href='removemember.php';";
					echo "</script>";
				}  
			}
		}  
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p>Remove a member using below given form</p>
				</div>
			</div>
		</div>
	</section>
