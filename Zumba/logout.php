			...
			<div class="row d-flex align-items-center justify-content-center">
				...
				<form method="POST" action="" align-center>
					<div class="input-group" >
						...
						<input type="submit" style="border:none" class="btn btn-lg btn-block" name="logout" value="Yes, I am sure"> <!--Yes, I am sure</button>--><br/>
					</div>
					<div class="input-group" >
						<input type="submit" style="border:none" class="btn btn-lg btn-block" name="no" value="No, I want to go back"> <!--No, I want to go back</button><br/> -->
					</div>
				</form>
				</div>
			</div>
